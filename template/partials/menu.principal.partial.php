  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto mb-2 mb-xl-0 gap-2 ms-xl-4">
        <li class="nav-item">
          <a class="nav-link <?= (isset($this->view) && $this->view == 'menu/main/index') ? 'active fw-bold' : '' ?>" href="<?= URL ?>menu">Nuestra Carta</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link <?= (isset($this->view) && $this->view == 'contact/index') ? 'active fw-bold' : '' ?>" href="<?= URL ?>contact">Contacto</a>
        </li>
      </ul>

      <div class="d-flex align-items-center mt-3 mt-xl-0 ms-xl-5">
        <ul class="navbar-nav ms-auto gap-2 w-100">
          <?php if (!empty($_SESSION['user_id']) && isset($_SESSION['user_name'])): ?>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle text-white border border-secondary rounded px-3 py-2 d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
