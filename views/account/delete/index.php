                        ...
                        <form action="<?= URL ?>account/delete_confirmed" method="post">
                            ...
                            <div class="mb-3 row mb-0">  
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <!-- cancelar eliminación cuenta -->
                                    <a class="btn btn-secondary" href="<?= URL ?>account"
                                        role="button">Cancelar</a>
                                        &nbsp;
                                    <!-- confirmar eliminación cuenta -->
                                    <button type="submit" class="btn btn-danger">Confirmar Eliminar cuenta</button>
                                </div>
                            </div>
